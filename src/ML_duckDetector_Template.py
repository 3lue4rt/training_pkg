...
class Nodo(object):
	def __init__(self, args):
		...
		self.detector = cv2.CascadeClassifier("/home/duckiebot/duckietown/catkin_ws/src/training_pkg/src/cascade3_LBP.xml")
		self.pub = rospy.Publisher("/duckiebot/ducktect", Image, queue_size=10)
